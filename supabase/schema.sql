-- ============================================================
-- LearnSpark: Supabase Schema for Learning Platform
-- Updated for Supabase Auth & Parent-Child Linking
-- ============================================================

-- [CAUTION] Uncomment the lines below if you are getting type mismatch errors 
-- (e.g. uuid = text) to start with a clean slate:
...
-- ============================================================
-- 1. PROFILES TABLE
-- Stores user profile data linked to Supabase Auth's user ID
-- ============================================================
...
-- Public READ for child usernames (to allow parents to find them)
CREATE POLICY "Public profiles are readable for linking"
  ON public.profiles FOR SELECT
  USING (role = 'CHILD');

-- ============================================================
-- 2. PARENT_CHILD_LINKS TABLE
-- Junction table for parent-child relationship
-- ============================================================
...
CREATE POLICY "Parents can add links"
  ON public.parent_child_links FOR INSERT
  WITH CHECK (auth.uid() = parent_id);

-- ============================================================
-- 3. MODULES TABLE (Unchanged)
-- ============================================================
...
-- ============================================================
-- 4. PROGRESS TABLE
-- Tracks student progress per module
-- ============================================================
...
-- ============================================================
-- 5. FUNCTION & TRIGGER for Profile Creation
-- ============================================================
CREATE OR REPLACE FUNCTION public.handle_new_user()
RETURNS TRIGGER AS $$
BEGIN
  -- Note: role and username will be passed during signup
  -- and stored in raw_user_meta_data for a moment
